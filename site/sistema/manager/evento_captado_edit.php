...
<form action="evento_captado_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)">
...
<tr>
	...
	<td valign="top">
		...
		<tr>
			<td class="structFilter" colspan="2"><u>Detalhes do Evento</u></td>
		</tr>
		<tr>
			...
			<td class="structFilter">
				...
				<tr>
					<td class="structFilter"><input type="checkbox" class="structFilterBox" name="espaco" id="espaco" <?= ($evento->getESPACO()) ? "checked" : "";?>></td>
					<td class="structFilter"><label for="espaco">Espaços</label>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="structFilter"><input type="checkbox" class="structFilterBox" name="apoio" id="apoio" <?= ($evento->getAPOIO()) ? "checked" : "";?>></td>
					<td class="structFilter"><label for="apoio">Apoio</label>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td class="structFilter"><input type="checkbox" class="structFilterBox" name="patroc" id="patroc" <?= ($evento->getPATROC()) ? "checked" : "";?>></td>
