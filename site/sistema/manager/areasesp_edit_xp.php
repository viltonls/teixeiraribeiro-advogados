...
if ($id_area!=""){
$id_p = $id_area;
$consulta=mysql_query("SELECT * FROM areas_esp where id_area='$id_p'"); 

//Fazendo o looping para exibição de todos registros que contiverem em nomedatabela

  $sql = "UPDATE areas_esp SET AREA_TITULO='$area_titulo', AREA_CORPO='$area_corpo', AREA_CURTO='$area_curto' WHERE ID_AREA='$id_area'";
   
}else{

   $sql = "INSERT INTO areas_esp (AREA_TITULO,AREA_CORPO,AREA_CURTO) VALUES ('".$area_titulo."','".$area_corpo."','".$area_curto."')";
