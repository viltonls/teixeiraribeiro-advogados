...
if (!session_is_registered("evento")) { 
	header("Location: session_seleciona_evento.php?url=inscricao_import_csv.php&orga_id=0&configurado=1");
} else {
...
<form name="importForm" method="post" action="inscricao_import_csv_columns.php" class="nospace" enctype="multipart/form-data" onsubmit="return disableForm(this)" accept-charset="ISO-8859-1">
