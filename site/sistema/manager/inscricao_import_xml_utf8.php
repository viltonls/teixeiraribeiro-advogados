...
if (!session_is_registered("evento")) { 
	header("Location: session_seleciona_evento.php?url=inscricao_import_xml_utf8.php&orga_id=0&configurado=1");
} else {
...
<form action="inscricao_import_xml_utf8_xp.php" method="POST">
