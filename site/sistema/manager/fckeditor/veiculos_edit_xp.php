...
$sql = "INSERT INTO veiculos (VEICULO_DIRECAO_HIDRAULICA,VEICULO_PELICULA,VEICULO_RODAS_LIGA_LEVE,VEICULO_TETO_SOLAR,VEICULO_VIDRO_ELETRICO,VEICULO_TRAVA_ELETRICA,VEICULO_OBS,VEICULO_VALOR,VEICULO_FOTO1,VEICULO_FOTO2,VEICULO_FOTO3,VEICULO_FOTO4,VEICULO_FOTO5,VEICULO_FOTO6,VEICULO_FOTO7,VEICULO_FOTO8,VEICULO_FOTO9,VEICULO_FOTO10) VALUES ('".$veiculo_direcao_eletrica."','".$veiculo_cambio_mecanico."','".$veiculo_direcao_hidraulica."','".$veiculo_pelicula."','".$veiculo_rodas_liga_leve."','".$veiculo_teto_solar."','".$veiculo_vidro_eletrico."','".$veiculo_trava_eletrica."','".$veiculo_obs."','".$veiculo_valor."','".$arquivo1_nome."','".$arquivo2_nome."','".$arquivo3_nome."','".$arquivo4_nome."','".$arquivo5_nome."','".$arquivo6_nome."','".$arquivo7_nome."','".$arquivo8_nome."','".$arquivo9_nome."','".$arquivo10_nome."')";
