...
foreach($xml->inscricao as $xmlInscricao) {
	...
	$inscricao->setEVEN_ID(transformSingleQuotes(utf8_decode($even_id)));
	...
	$inscricao->setNOME(transformSingleQuotes(utf8_decode($xmlInscricao->nome)));
	$inscricao->setCRACHA(transformSingleQuotes(utf8_decode($xmlInscricao->cracha)));
	...
	$inscricao->setREGISTRO_PROF(transformSingleQuotes(utf8_decode($xmlInscricao->registro_prof)));
	$inscricao->setESPECIALIDADE(transformSingleQuotes(utf8_decode($xmlInscricao->especialidade)));
	$inscricao->setEMAIL(transformSingleQuotes(utf8_decode($xmlInscricao->email)));
	...
	$inscricao->setENDERECO(transformSingleQuotes(utf8_decode($xmlInscricao->endereco)));
	$inscricao->setCEP($xmlInscricao->cep);
	$inscricao->setBAIRRO(transformSingleQuotes(utf8_decode($xmlInscricao->bairro)));
	$inscricao->setCIDADE(transformSingleQuotes(utf8_decode($xmlInscricao->cidade)));
	$inscricao->setESTADO(transformSingleQuotes(utf8_decode($xmlInscricao->estado)));
	$inscricao->setPAIS(transformSingleQuotes(utf8_decode($xmlInscricao->pais)));
	...
	$inscricao->setORG_NOME(transformSingleQuotes(utf8_decode($xmlInscricao->org_nome)));
	$inscricao->setORG_CARGO(transformSingleQuotes(utf8_decode($xmlInscricao->org_cargo)));
	$inscricao->setORG_FONE($xmlInscricao->org_fone);
	$inscricao->setORG_CNPJ($xmlInscricao->org_cnpj);
	$inscricao->setORG_ENDERECO(transformSingleQuotes(utf8_decode($xmlInscricao->org_endereco)));
	$inscricao->setORG_CIDADE(transformSingleQuotes(utf8_decode($xmlInscricao->org_cidade)));
	$inscricao->setORG_WEBSITE(transformSingleQuotes(utf8_decode($xmlInscricao->org_website)));
	$inscricao->setACOMP(transformSingleQuotes(utf8_decode($xmlInscricao->acomp)));
	$inscricao->setOBS(transformSingleQuotes(utf8_decode($xmlInscricao->obs)));
	$inscricao->setTEXTO_1(transformSingleQuotes(utf8_decode($xmlInscricao->texto_1)));
	$inscricao->setTEXTO_2(transformSingleQuotes(utf8_decode($xmlInscricao->texto_2)));
	$inscricao->setTEXTO_3(transformSingleQuotes(utf8_decode($xmlInscricao->texto_3)));
	$inscricao->setTEXTO_4(transformSingleQuotes(utf8_decode($xmlInscricao->texto_4)));
	$inscricao->setTEXTO_5(transformSingleQuotes(utf8_decode($xmlInscricao->texto_5)));
	$inscricao->setTEXTO_6(transformSingleQuotes(utf8_decode($xmlInscricao->texto_6)));
	$inscricao->setTEXTO_7(transformSingleQuotes(utf8_decode($xmlInscricao->texto_7)));
	$inscricao->setTEXTO_8(transformSingleQuotes(utf8_decode($xmlInscricao->texto_8)));
	$inscricao->setTEXTO_9(transformSingleQuotes(utf8_decode($xmlInscricao->texto_9)));
	$inscricao->setTEXTO_10(transformSingleQuotes(utf8_decode($xmlInscricao->texto_10)));
