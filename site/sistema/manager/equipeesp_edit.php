...
$consulta=mysql_query("SELECT * FROM equipe_esp WHERE ID_EQUIPE='$id_equipe'"); 
...
<div class="structTitle">Editar Membro da Equipe em Espanhol</div>

<div style="padding-top:8px;"></div>

<form action="equipeesp_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)" enctype="multipart/form-data">
