...
?>
<div class="structTitle">Listar Notícias "<?=$eventoAtual->getNOME()?>"</div>
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="noticias_edit.php?id=<?= $id_noticia;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="noticias_delete_xp2.php?id=<?= $id_noticia;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
