...
$consulta=mysql_query("SELECT * FROM areas_ing WHERE ID_AREA='$id_area'"); 
...
<div class="structTitle">Editar Área em Inglês</div>

<div style="padding-top:8px;"></div>

<form action="areasing_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)" enctype="multipart/form-data">
