...
?>
<div class="structTitle">Listar Áreas em Italiano</div>
...
$consulta=mysql_query("SELECT * FROM areas_ita order by id_area ASC"); 
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="areasita_edit.php?id=<?= $id_area;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="areasita_delete_xp2.php?id=<?= $id_area;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
