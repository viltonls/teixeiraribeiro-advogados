...
?>
<div class="structTitle">Listar Clientes "<?=$eventoAtual->getNOME()?>"</div>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr class="gridHeader" style="top:expression(document.getElementById('tC').scrollTop);">
	...
	<td class="gridHeader" width="2%">&nbsp;</td>
	 ...
	 <td width="32%" class="gridHeader">Nome</td>
	 <td width="32%" class="gridHeader">Produto</td>
	 <td width="10%" class="gridHeader">Estado</td>
     <td width="10%" class="gridHeader">Ordem </td>
...
$consulta=mysql_query("SELECT * FROM clientes order by clientes_nome ASC "); 
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="clientes_edit.php?id=<?= $id_clientes;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="clientes_delete_xp2.php?id=<?= $id_clientes;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
