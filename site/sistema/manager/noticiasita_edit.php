...
$consulta=mysql_query("SELECT * FROM noticias_ita WHERE ID_NOTICIA='$id_noticia'"); 
...
<div class="structTitle">Editar Notícias em Italiano</div>

<div style="padding-top:8px;"></div>

<form action="noticiasita_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)" enctype="multipart/form-data">
