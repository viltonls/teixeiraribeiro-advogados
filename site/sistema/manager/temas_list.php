...
?>
<div class="structTitle">Listar Temas "<?=$eventoAtual->getNOME()?>"</div>
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="temas_edit.php?id=<?= $id_temas;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="temas_delete_xp2.php?id=<?= $id_temas;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
