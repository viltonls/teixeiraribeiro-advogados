...
$consulta=mysql_query("SELECT * FROM escritorio_ing"); //WHERE ID_escritorio='$id_escritorio'
...
<div class="structTitle">Editar Escritorio em Inglês</div>

<div style="padding-top:8px;"></div>

<form action="escritorioing_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)" enctype="multipart/form-data">
