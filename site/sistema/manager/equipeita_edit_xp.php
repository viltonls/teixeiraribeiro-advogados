...
if ($id_equipe!=""){
$id_p = $id_equipe;
$consulta=mysql_query("SELECT * FROM equipe_ita where id_equipe='$id_p'"); 

//Fazendo o looping para exibição de todos registros que contiverem em nomedatabela

  $sql = "UPDATE equipe_ita SET EQUIPE_NOME='$equipe_nome', EQUIPE_CURRICULO='$equipe_curriculo', EQUIPE_AREA='$equipe_area', EQUIPE_IDIOMA='$equipe_idioma', EQUIPE_EMAIL='$equipe_email', EQUIPE_SOCIO='$equipe_socio' WHERE ID_EQUIPE='$id_equipe'";
   
}else{

   $sql = "INSERT INTO equipe_ita (EQUIPE_NOME,EQUIPE_CURRICULO,EQUIPE_AREA,EQUIPE_IDIOMA,EQUIPE_EMAIL,EQUIPE_SOCIO) VALUES ('".$equipe_nome."','".$equipe_curriculo."','".$equipe_area."','".$equipe_idioma."','".$equipe_email."','".$equipe_socio."')";
