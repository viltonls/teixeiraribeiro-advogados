...
<tr>
	<td valign="middle"><div id="cracha<?=$inscricao->getID()?>" style="display: inline-block;font-family:arial, helvetica; font-size:10pt; border: 0px solid gray;" align="center">
	...
	<td nowrap align="bottom"><div id="texto" style="writing-mode: tb-rl;display: block;font-family:arial, helvetica; font-size:10pt; border: 0px solid gray" align="center">
			...
			?></b></span><br>
			<span style="font-size:10pt;line-height:100%"><?= strtoupper2($inscricao->getNOME())?></span><br>
			<span style="font-size:10pt;line-height:100%"><b><?= substr(strtoupper2($inscricao->getORG_NOME()),0,20)?></b></span>
			<span style="font-size:10pt;line-height:100%"><? 
				if ($inscricao->getCIDADE()) echo strtoupper2($inscricao->getCIDADE());
				if ($inscricao->getESTADO()) echo " / ".substr(strtoupper2($inscricao->getESTADO()),0,6);
			?></span><br>
			<span style="font-size:10pt;line-height:100%"><? 
				if ($inscricao->getPAIS()) echo strtoupper2($inscricao->getPAIS());
			?></span><br>
			<span style="font-size:14pt;line-height:100%"><b><?
