...
$consulta=mysql_query("SELECT * FROM areas WHERE ID_AREA='$id_area'"); 
...
<div class="structTitle">Editar Área</div>

<div style="padding-top:8px;"></div>

<form action="areas_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)" enctype="multipart/form-data">
