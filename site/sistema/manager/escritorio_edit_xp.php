...
if ($id_escritorio!=""){
$id_p = $id_escritorio;
$consulta=mysql_query("SELECT * FROM escritorio where id_escritorio='$id_p'"); 
while ($dados = mysql_fetch_array($consulta)) {
$id_escritorio=$dados['id_escritorio'];
}


  $sql = "UPDATE escritorio SET APRESENTACAO='$apresentacao', MISSAO='$missao', VISAO='$visao', CODIGO='$codigo', PARCERIAS='$parcerias' WHERE ID_ESCRITORIO='$id_escritorio'";
   ...
   $sql = "INSERT INTO escritorio (APRESENTACAO,MISSAO,VISAO,CODIGO,PARCERIAS) VALUES ('".$apresentacao."','".$missao."','".$visao."','".$codigo."','".$parcerias."')";
