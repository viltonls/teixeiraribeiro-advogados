...
?>
<div class="structTitle">Listar Notícias em Espanhol</div>
...
$consulta=mysql_query("SELECT * FROM noticias_esp order by noticia_data DESC"); 
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="noticiasesp_edit.php?id=<?= $id_noticia;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="noticiasesp_delete_xp2.php?id=<?= $id_noticia;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
