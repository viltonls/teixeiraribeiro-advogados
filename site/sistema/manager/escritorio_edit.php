...
$consulta=mysql_query("SELECT * FROM escritorio WHERE ID_escritorio='$id_escritorio'"); //WHERE ID_escritorio='$id_escritorio' 
...
<div class="structTitle">Editar Escritorio </div>

<div style="padding-top:8px;"></div>

<form action="escritorio_edit_xp.php" method="POST" class="form.nospace" onsubmit="return validateForm(this)" enctype="multipart/form-data">
