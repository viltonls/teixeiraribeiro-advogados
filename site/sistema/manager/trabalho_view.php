...
<form action="javascript:history.back();" method="POST" class="form.nospace" onSubmit="return validateForm(this)">
    ...
    <table border="0" cellpadding="0" cellspacing="4">
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"> 
				...
				<select class="structFilterBox" name="status" disabled>
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"> <select class="structFilterBox" name="area" id="area" disabled>
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"> <textarea readonly class="structFilterBox" name="intro" rows="5" cols="120"><?= $trabalho->getINTRO()?></textarea> </td>
		</tr>
		<tr> 
			<td class="structFilter">Objetivo</td>
			<td class="structFilter" colspan="3"> <textarea readonly class="structFilterBox" name="objetivo" rows="5" cols="120"><?= $trabalho->getOBJETIVO()?></textarea> </td>
		</tr>
		<tr> 
			<td class="structFilter">Materiais e Métodos</td>
			<td class="structFilter" colspan="3"> <textarea readonly class="structFilterBox" name="materiais" rows="5" cols="120"><?= $trabalho->getMATERIAIS()?></textarea> </td>
		</tr>
		<tr> 
			<td class="structFilter">Resultados</td>
			<td class="structFilter" colspan="3"> <textarea readonly class="structFilterBox" name="resultados" rows="5" cols="120"><?= $trabalho->getRESULTADOS()?></textarea> </td>
		</tr>
		<tr> 
			<td class="structFilter">Conclusão</td>
			<td class="structFilter" colspan="3"> <textarea readonly class="structFilterBox" name="conclusao" rows="5" cols="120"><?= $trabalho->getCONCLUSAO()?></textarea> </td>
		</tr>
		<tr> 
			<td class="structFilter">Palavras-chave</td>
			<td class="structFilter" colspan="3"> 
			<input readonly type="edit" class="structFilterBox" name="titulo" value="<?= $trabalho->getPALAVRA1()?>" size="120" maxlength="50"> 
			<input readonly type="edit" class="structFilterBox" name="titulo" value="<?= $trabalho->getPALAVRA2()?>" size="120" maxlength="50"> 
			<input readonly type="edit" class="structFilterBox" name="titulo" value="<?= $trabalho->getPALAVRA3()?>" size="120" maxlength="50"> 
			</td>
		</tr>
		<tr> 
			<td class="structFilter">Resumo</td>
			<td class="structFilter" colspan="3"><textarea readonly class="structFilterBox" name="resumo" rows="5" cols="120"><?= $trabalho->getRESUMO()?></textarea></td>
		</tr>
		<?}?>
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"><textarea readonly class="structFilterBox" name="resumo" rows="5" cols="120"><?= $trabalho->getAUTORIZACAO()?></textarea></td>
		</tr>
		<tr> 
			<td class="structFilter">Resumo Co-Autor 1<br>(<?= isset( $words[1] ) ? $words[1] : '' ?> palavras )</td>
			<td class="structFilter" colspan="3"><input type="text" readonly="readonly" value="<?= $subtitulos['0'] ?>" class="structFilterBox"><br><textarea readonly class="structFilterBox" name="resumo" rows="5" cols="120"><?= $trabalho->getAUTORIZACAO()?></textarea></td>
		</tr>
		<tr> 
			<td class="structFilter">Resumo Co-Autor 2<br>(<?= isset( $words[2] ) ? $words[2] : '' ?> palavras )</td>
			<td class="structFilter" colspan="3"><input type="text" readonly="readonly" value="<?= $subtitulos['1'] ?>" class="structFilterBox"><br><textarea readonly class="structFilterBox" name="resumo" rows="5" cols="120"><?= $trabalho->getCORPO()?></textarea></td>
		</tr>
		<tr> 
			<td class="structFilter">Resumo Co-Autor 3<br>(<?= isset( $words[3] ) ? $words[3] : '' ?> palavras )</td>
			<td class="structFilter" colspan="3"><input type="text" readonly="readonly" value="<?= $subtitulos['2'] ?>" class="structFilterBox"><br><textarea readonly class="structFilterBox" name="resumo" rows="5" cols="120"><?= $trabalho->getBIBLIOGRAFIA()?></textarea></td>
		</tr>
		<tr> 
			<td class="structFilter">Resumo Co-Autor 4<br>(<?= isset( $words[4] ) ? $words[4] : '' ?> palavras )</td>
			<td class="structFilter" colspan="3"><input type="text" readonly="readonly" value="<?= $subtitulos['3'] ?>" class="structFilterBox"><br><textarea readonly class="structFilterBox" name="resumo" rows="5" cols="120"><?= $trabalho->getOBS()?></textarea></td>
		</tr>
		<?php } ?>
		<?php if($eventoAtual->getID() == 18 || $eventoAtual->getID() == 23) echo '<!--'; ?>
		<tr> 
			<td class="structFilter">Corpo</td>
			<td class="structFilter" colspan="3"><textarea readonly class="structFilterBox" name="corpo" rows="5" cols="120"><?= $trabalho->getCORPO()?></textarea></td>
		</tr>
		<tr> 
			<td class="structFilter">Bibliografia</td>
			<td class="structFilter" colspan="3"><textarea readonly class="structFilterBox" name="bibliografia" rows="5" cols="120"><?= $trabalho->getBIBLIOGRAFIA()?></textarea></td>
		</tr>
		<?php if($eventoAtual->getID() == 18 || $eventoAtual->getID() == 23) echo '-->'; ?>
		<? } ?>
		<?php if( $eventoAtual->getID() == 23){ ?>
		<tr> 
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"> 
					<select disabled class="structFilterBox" name="opcao1" id="opcao1">
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"> 
					<select disabled class="structFilterBox" name="opcao2" id="opcao2">
		...
		<?php if($eventoAtual->getID() == 23) echo '<!--'; ?>
		<tr> 
			<td class="structFilter" colspan="4"><u>Opções</u></td>
		</tr>
		<tr> 
			<td class="structFilter">Opção 1</td>
			<td class="structFilter" colspan="3"><input readonly type="edit" class="structFilterBox" name="opcao1" value="<?= $trabalho->getOPCAO1()?>" size="120" maxlength="200"></td>
		</tr>
		<tr> 
			<td class="structFilter">Opção 2</td>
			<td class="structFilter" colspan="3"><input readonly type="edit" class="structFilterBox" name="opcao2" value="<?= $trabalho->getOPCAO2()?>" size="120" maxlength="200"></td>
		</tr>
		<tr> 
			<td class="structFilter">Opção 3</td>
			<td class="structFilter" colspan="3"><input readonly type="edit" class="structFilterBox" name="opcao3" value="<?= $trabalho->getOPCAO3()?>" size="120" maxlength="200"></td>
		</tr>
		<?php if( ! $eventoAtual->getID() == 18 ) { ?>
		<tr> 
			<td class="structFilter">Opção 4</td>
			<td class="structFilter" colspan="3"><input readonly type="edit" class="structFilterBox" name="opcao4" value="<?= $trabalho->getOPCAO4()?>" size="120" maxlength="200"></td>
		</tr>
		<tr> 
			<td class="structFilter">Opção 5</td>
			<td class="structFilter" colspan="3"><input readonly type="edit" class="structFilterBox" name="opcao5" value="<?= $trabalho->getOPCAO5()?>" size="120" maxlength="200"></td>
		</tr>
		<?php } ?>
		<?php if( $eventoAtual->getID() == 23) echo '-->'; ?>
		<?php if($eventoAtual->getID() == 18) echo '<!--'; ?>		
		...
		<tr> 
			...
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="apres_nome" value="<?= $trabalho->getAPRES_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="apres_email" value="<?= $trabalho->getAPRES_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">Organização</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="apres_orga" value="<?= $trabalho->getAPRES_ORGA()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Telefone</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="apres_fone" value="<?= $trabalho->getAPRES_FONE()?>" size="20" maxlength="20"></td>
		</tr>
		<?php if($eventoAtual->getID() == 23) { ?>
		<tr>
			<td class="structFilter">CPF/Passaporte</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor1_nome" value="<?= $trabalho->getAPRES_CPF_PASSAPORTE()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Celular</td>
			<td class="structFilter"><input readonly name="apres_celular" type="edit" class="structFilterBox" id="apres_celular" value="<?= $trabalho->getAPRES_CELULAR()?>" size="20" maxlength="20"></td>
		</tr>
		<?php } else {?>
		<tr> 
			...
			<td class="structFilter">&nbsp;</td>
			<td class="structFilter">Celular</td>
			<td class="structFilter"><input name="apres_celular" type="edit" class="structFilterBox" id="apres_celular" value="<?= $trabalho->getAPRES_CELULAR()?>" size="20" maxlength="20" readonly></td>
		</tr>
		<?php } ?>
		<?php if($eventoAtual->getID() == 23) echo '<!--'; ?>		
		<tr> 
		...
		<tr> 
			<td class="structFilter">Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor_nome" value="<?= $trabalho->getAUTOR_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor_email" value="<?= $trabalho->getAUTOR_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">Organização</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor_orga" value="<?= $trabalho->getAUTOR_ORGA()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Telefone</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor_fone" value="<?= $trabalho->getAUTOR_FONE()?>" size="20" maxlength="20"></td>
		</tr>
		<tr> 
			<td class="structFilter">Cidade</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor_cidade" value="<?= $trabalho->getAUTOR_CIDADE()?>" size="25" maxlength="20">
				UF 
			...
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor_pais" value="<?= $trabalho->getAUTOR_PAIS()?>" size="20" maxlength="20"></td>
		</tr>
		<?php if($eventoAtual->getID() == 18) echo '-->'; ?>
		<?php if( $eventoAtual->getID() == 23) echo '-->'; ?>
		<tr> 
		...
		<tr> 
			...
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor1_nome" value="<?= $trabalho->getAUTOR1_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor1_email" value="<?= $trabalho->getAUTOR1_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<?php if($eventoAtual->getID() == 18) { ?>
		<tr>
			<td class="structFilter">CPF/Passaporte</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor1_nome" value="<?= $trabalho->getAUTOR1_CPF_PASSAPORTE()?>" size="40" maxlength="50"></td>
		...
		<tr> 
			...
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor2_nome" value="<?= $trabalho->getAUTOR2_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor2_email" value="<?= $trabalho->getAUTOR2_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">03: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor3_nome" value="<?= $trabalho->getAUTOR3_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor3_email" value="<?= $trabalho->getAUTOR3_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">04: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor4_nome" value="<?= $trabalho->getAUTOR4_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor4_email" value="<?= $trabalho->getAUTOR4_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">05: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor5_nome" value="<?= $trabalho->getAUTOR5_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor5_email" value="<?= $trabalho->getAUTOR5_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">06: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor6_nome" value="<?= $trabalho->getAUTOR6_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor6_email" value="<?= $trabalho->getAUTOR6_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">07: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor7_nome" value="<?= $trabalho->getAUTOR7_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor7_email" value="<?= $trabalho->getAUTOR7_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">08: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor8_nome" value="<?= $trabalho->getAUTOR8_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor8_email" value="<?= $trabalho->getAUTOR8_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">09: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor9_nome" value="<?= $trabalho->getAUTOR9_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor9_email" value="<?= $trabalho->getAUTOR9_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<tr> 
			<td class="structFilter">10: Nome</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor10_nome" value="<?= $trabalho->getAUTOR10_NOME()?>" size="40" maxlength="50"></td>
			<td class="structFilter">Email</td>
			<td class="structFilter"><input readonly type="edit" class="structFilterBox" name="autor10_email" value="<?= $trabalho->getAUTOR10_EMAIL()?>" size="40" maxlength="50"></td>
		</tr>
		<?php if($eventoAtual->getID() == 23) { ?>
		<tr> 
		...
		<tr> 
			...
			<td class="structFilter"> <input readonly type="edit" class="structFilterBox" name="instituicao1" value="<?= $trabalho->getINSTITUICAO1()?>" size="40" maxlength="50"> </td>
			<td class="structFilter">Instituição 2</td>
			<td class="structFilter"> <input readonly type="edit" class="structFilterBox" name="instituicao2" value="<?= $trabalho->getINSTITUICAO2()?>" size="40" maxlength="50"> </td>
		</tr>
		<tr> 
			<td class="structFilter">Instituição 3</td>
			<td class="structFilter"> <input readonly type="edit" class="structFilterBox" name="instituicao3" value="<?= $trabalho->getINSTITUICAO3()?>" size="40" maxlength="50"> </td>
			<td class="structFilter">Instituição 4</td>
			<td class="structFilter"> <input readonly type="edit" class="structFilterBox" name="instituicao4" value="<?= $trabalho->getINSTITUICAO4()?>" size="40" maxlength="50"> </td>
		</tr>
		<tr> 
		...
		<tr> 
			...
			<td class="structFilter"> 
			<select disabled class="structFilterBox" name="area" id="area">
			...
			<td class="structFilter">Cidade</td>
			<td class="structFilter"> <input readonly type="edit" class="structFilterBox" name="cidade" value="<?= $trabalho->getCIDADE()?>" size="40" maxlength="50"> </td>
		</tr>
		<?php } ?>
		<?php if($eventoAtual->getID() == 18) echo '<!--'; ?>
		<tr> 
		...
		<tr> 
			...
			<td class="structFilter" colspan="3"><textarea readonly class="structFilterBox" name="autorizacao" rows="5" cols="120"><?= $trabalho->getAUTORIZACAO()?></textarea></td>
		</tr>
		<tr> 
			<td class="structFilter">Observações</td>
			<td class="structFilter" colspan="3"><textarea readonly class="structFilterBox" name="obs" rows="5" cols="120"><?= $trabalho->getOBS()?></textarea></td>
		</tr>
		<?php if($eventoAtual->getID() == 18) echo '-->'; ?>
		<tr> 
			<td class="structFilter">&nbsp;&nbsp;&nbsp;</td>
