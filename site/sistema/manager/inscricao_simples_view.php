...
<tr>
	<td valign="top">
		...
		<tr>
			<td class="structFilterSimple" colspan="4"><b>Inscrição Simplificada - SALVA (id: <?=$inscricao->getID()?>)</b><div style="padding-top:8px;"></div></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="structFilterSimple" colspan="2">
				...
				País: <input style="background:#f0f0f0" type="edit" class="structFilterSimpleBox" name="pais" id="pais" value="<?= $inscricao->getPAIS()?>" onKeyUp="javascript:setUpperCase(this);" size="20" maxlength="20" readonly></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="structFilterSimple" colspan="3" nowrap>
				...
				<a style="text-decoration:none;" class="structFilterSimpleButton" href="inscricao_simples_edit.php?id=<?=$inscricao->getID()?>"><< Corrigir Inscrição</a>
				<a style="text-decoration:none;" class="structFilterSimpleButton" href="inscricao_simples_edit.php">Nova Inscrição</a>
				|
				<a style="text-decoration:none; background:#9999FF; color:white" class="structFilterSimpleButton" href="javascript:imprimirCracha();">Crachá</a>
				<? if ($inscricao->getACOMP() != null && $inscricao->getACOMP() != "") { ?>
				<a style="text-decoration:none; background:#9999FF; color:white" class="structFilterSimpleButton" href="javascript:imprimirCrachaAcompanhante();">Crachá Acomp.</a>
				<? } else { ?>
				<span style="text-decoration:none; background:#9999FF; color:#D0D0D0" class="structFilterSimpleButton">Crachá Acomp.</span>
				<? }?>
