	...
	<td nowrap align="bottom"><div id="texto" style="writing-mode: tb-rl;display: block;font-family:arial, helvetica; font-size:10pt; border: 0px solid gray" align="center">
			...
			<span style="font-size:20pt"><b><?
				if ($inscricao->getCRACHA()) {
					echo strtoupper($inscricao->getCRACHA());
				} else {
					$nomeArray = explode(" ",$inscricao->getNOME());
					echo strtoupper($nomeArray[0]);
				}
			?></b></span><br>
			<span style="font-size:10pt;line-height:110%"><?= strtoupper($inscricao->getNOME())?></span><br>
			<span style="font-size:10pt;line-height:110%"><b><?= substr(strtoupper($inscricao->getORG_NOME()),0,30)?></b></span>
			<span style="font-size:10pt;line-height:110%"><b><?
