...
if ($id_noticia!=""){
$id_p = $id_noticia;
$consulta=mysql_query("SELECT * FROM noticias_esp where id_noticia='$id_p'"); 
...
if(isset($_FILES["noticia_doc"])){
  ...
  $sql = "UPDATE noticias_esp SET NOTICIA_TITULO='$noticia_titulo', NOTICIA_DATA='$noticia_data', NOTICIA_CORPO='$noticia_corpo', NOTICIA_DOC='$arquivo1_nome' WHERE ID_NOTICIA='$id_noticia'";
...
if(isset($_FILES["noticia_doc"])){
  //$pasta_dir = "./imagens/";
   ...
   $sql = "INSERT INTO noticias_esp (NOTICIA_TITULO,NOTICIA_DATA,NOTICIA_CORPO,NOTICIA_DOC) VALUES ('".$noticia_titulo."','".$noticia_data."','".$noticia_corpo."','".$arquivo1_nome."')";
