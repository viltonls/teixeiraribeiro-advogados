...
?>
<div class="structTitle">Listar Depoimentos "<?=$eventoAtual->getNOME()?>"</div>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr class="gridHeader" style="top:expression(document.getElementById('tC').scrollTop);">
	...
	<td class="gridHeader" width="2%">&nbsp;</td>
	 ...
	 <td width="52%" class="gridHeader">Nome</td>
     <td width="27%" class="gridHeader">Dados </td>
	 <td width="27%" class="gridHeader">Ordem </td>
...
$consulta=mysql_query("SELECT * FROM depoimentos order by id_depoimentos DESC"); 
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven">
		<?= $depoimentos_dadoscomplementares?>
    </td>
	 <td class="gridLineEven">
		<?= $depoimentos_ordem?>
    </td>
    ...
    <td class="gridLineEven"><a href="depoimentos_edit.php?id=<?= $id_depoimentos;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="depoimentos_delete_xp2.php?id=<?= $id_depoimentos;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
