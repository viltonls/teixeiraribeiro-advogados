...
?>
<div class="structTitle">Listar Membros da Equipe</div>
...
$consulta=mysql_query("SELECT * FROM equipe order by id_equipe ASC"); 
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="equipe_edit.php?id=<?= $id_equipe;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="equipe_delete_xp2.php?id=<?= $id_equipe;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
