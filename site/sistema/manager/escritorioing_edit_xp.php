...
if ($id_escritorio!=""){
$id_p = $id_escritorio;
$consulta=mysql_query("SELECT * FROM escritorio_ing where id_escritorio='$id_p'"); 
while ($dados = mysql_fetch_array($consulta)) {
$id_escritorio=$dados['id_escritorio'];
}


  $sql = "UPDATE escritorio_ing SET APRESENTACAO='$apresentacao', MISSAO='$missao', VISAO='$visao', CODIGO='$codigo', PARCERIAS='$parcerias' WHERE ID_ESCRITORIO='$id_escritorio'";
   ...
   $sql = "INSERT INTO escritorio_ing (APRESENTACAO,MISSAO,VISAO,CODIGO,PARCERIAS) VALUES ('".$apresentacao."','".$missao."','".$visao."','".$codigo."','".$parcerias."')";
