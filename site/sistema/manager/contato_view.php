...
<div class="structTitle">Visualizar Contato</div>
	...
	<td width="50%" valign="top">
		...
		<tr>
			...
			<td class="structFilter">
				<select name="orga_id" id="ajaxmenu" size="1" onChange="ajaxcombo('ajaxmenu', 'eventoSelectArea');this.form.orga_id" class="structFilterBox" readonly disabled>
				<?
					if (!$orga_id) {
		...
		<tr>
			...
			<td class="structFilter">
				<select class="structFilterBox" name="tipo" readonly disabled>
		...
		<tr>
			...
			<td class="structFilter">
				<select name="diaData1" id="selDay1" onchange="changeDate1()" style="vertical-align:middle" class="structFilterBox" readonly disabled>
					<? for ($i = 1; $i <= 31; $i++) { ?>
					<option value="<?=$i?>"><?=$i?></option>
					<? } ?>
				</select>
				<select name="mesData1" id="selMonth1" onchange="changeDate1()" style="vertical-align:middle" class="structFilterBox" readonly disabled>
				...
				<select name="anoData1" id="selYear1" onchange="changeDate1()" style="vertical-align:middle" class="structFilterBox" readonly disabled>
		...
		<tr>
			...
			<td class="structFilter"><textarea class="structFilterBox" name="obs" rows="5" cols="120" readonly><?= $contato->getOBS()?></textarea></td>
		</tr>
		</table>
	</td>
</tr>
