...
?>
<div class="structTitle">Listar Áreas em Espanhol</div>
...
?>
  ...
  <tr>
   <td class="gridLineEven">&nbsp;
    ...
    <td class="gridLineEven"><a href="areasesp_edit.php?id=<?= $id_area;  ?>">Editar</a>&nbsp;</td>
   
    <td class="gridLineEven">&nbsp;<a href="areasesp_delete_xp2.php?id=<?= $id_area;  ?>" onClick="return confirm('Você tem certeza que deseja excluir?\n(essa operação não pode ser desfeita)')">Excluir</a></td>
