...
*/
 ...
 function OpenLink()
 { // Method : begin
  $this->link = @mysql_connect($this->host,$this->user,$this->password) or die (print "DB Error: ".mysql_error()."<br><br>Por favor, copie o erro descrito acima e envie por email à equipe de suporte.");
 } // Method : end
 
 function SelectDB()
 { // Method : begin
 @mysql_select_db($this->database,$this->link) or die (print "DB Error: ".mysql_error()."<br><br>Por favor, copie o erro descrito acima e envie por email à equipe de suporte.");
 ...
 $this->result = mysql_query($query,$this->link) or die (print "DB Error: ".mysql_error()."<br><br>Por favor, copie o erro descrito acima e envie por email à equipe de suporte.");
