...
<div class="conteudo">
<div id="texto_int3">
<p class="tit2">Equipo</p><br /><br />
  <p class="texto">Haga clic sobre el nombre de cada profesional para  visualizar su curr&iacute;culo.</p>
  <br /><br />
  <div id="geral"> 
<div id="efeito"> 
<?php
...
$consulta=mysql_query("SELECT * FROM equipe_esp where equipe_socio='1' order by id_equipe desc"); 
...
<br />
<strong>Principales Áreas de Práctica:</strong><br />
...
//Consulta com a tabela
//Selecione tudo de nomedatabela em ordem crescente pelo nome 
$consulta=mysql_query("SELECT * FROM equipe_esp where equipe_socio='0' order by id_equipe desc"); 
