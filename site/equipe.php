...
$consulta=mysql_query("SELECT * FROM equipe where equipe_socio='1' order by id_equipe asc"); 
...
//Consulta com a tabela
//Selecione tudo de nomedatabela em ordem crescente pelo nome 
$consulta=mysql_query("SELECT * FROM equipe where equipe_socio='0' order by id_equipe asc"); 
...
<a href="#" class="texto_curriculo"> <? echo"$nomedecode";?></a> 
    <div> 
    <span class="texto_curriculo"><? echo"$equipe_curriculo";?></span><br />
<br />
<span class="texto_curriculo"><strong>Principais &aacute;reas de pr&aacute;tica</strong></span><br />
<span class="texto_curriculo"><? echo"$areadecode";?></span><br /><br />
<span class="texto_curriculo"><strong>Idiomas</strong></span> <br />
<span class="texto_curriculo"><? echo"$idiomadecode";?> </span><br /><br />
<a class="texto_curriculo" href="mailto:<? echo"$equipe_email";?>" target="_blank"><? echo"$equipe_email";?></a></p>
    <br />
<p><img src="img/friso2.png" /></p>
<br /><br />
