...
$consulta=mysql_query("SELECT * FROM escritorio_ing"); 
...
?>
  <span class="texto"><? echo"$missao";?>
  <br /><br /><br /><br />
<p class="tit2">Vision</p><br /><br />
 <span class="texto"><? echo"$visao";?></span>
  <br /><br /><br /><br />
  <p class="tit2">Code of Ethics </p>
  <br /><br />
  <span class="texto"><? echo"$codigo";?></span>
