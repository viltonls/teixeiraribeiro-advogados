...
<div class="container_16">
<div id="titulo1" class="tit">CONTACT</div>
<div class="fundo_menu_internas"><div id="menu_int">
  <p class="menu_internas"><a href="contato.htm" target="_top" class="menu_internas">CONTACT</a> | <a href="area_cliente.htm" target="_top" class="menu_internas">CLIENT'S SECTION</a></p>
</div></div>
<div class="conteudo">
<div id="texto_int2">
<p class="texto">
...
if (!$mail->Send())
{
	echo "Your message hasn't been sent. Try again!";
}
else
{
	echo "$nome seu e-mail your message has been sent successfully!<br><br>";
	echo "Thanks for your contact. We'll reply you soon.";
}
