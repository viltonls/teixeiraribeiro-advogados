...
<div class="container_16">
<div id="titulo1" class="tit">FIRM</div>
<div class="fundo_menu_internas"><div id="menu_int">
  <p class="menu_internas"><a href="escritorio.php" target="_top" class="menu_internas">PRESENTATION</a> | <a href="visao.php" target="_top" class="menu_internas">MISSION, VISION AND CODE OF ETHICS</a> | <a href="equipe.php" target="_top" class="menu_internas">TEAM</a> | <a href="parcerias.php" target="_top" class="menu_internas">STRATEGIC PARTNERS</a><a href="linha.htm" target="_top" class="menu_internas"></a><a href="linha.htm" target="_top" class="menu_internas"></a><a href="linha.htm" target="_top" class="menu_internas"></a><a href="linha.htm" target="_top" class="menu_internas"></a></p>
  </div></div>
<div class="conteudo">
<div id="texto_int3">
<p class="tit2">Team</p><br /><br />
  </p><p class="texto">Click on the name of each professional to see the curriculum.</p>
  <br /><br />
  <div id="geral"> 
<div id="efeito"> 
<?php
...
$consulta=mysql_query("SELECT * FROM equipe_ing where equipe_socio='1' order by id_equipe desc"); 
...
<br />
<strong>Leading Areas of Practice:</strong><br />
...
//Consulta com a tabela
//Selecione tudo de nomedatabela em ordem crescente pelo nome 
$consulta=mysql_query("SELECT * FROM equipe_ing where equipe_socio='0' order by id_equipe asc"); 
